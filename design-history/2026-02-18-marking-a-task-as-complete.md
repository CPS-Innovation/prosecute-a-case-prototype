...
But many tasks require users to do the work separately and then come back to mark them as complete. This flow handles those tasks.

Users reach the flow by clicking "Complete task" on the [task details page](2026-02-18-adding-a-task-details-page.md).
...
After confirming, the user is taken back to the [case task list](2026-02-18-allowing-users-to-see-tasks-for-a-specific-case.md) where a success banner confirms "Task completed". The completed task no longer appears in the list.
